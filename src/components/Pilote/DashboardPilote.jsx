...
function getMasseAlt(m0, alt) {
  ...
  if (a <= 0) return m0
  return m0 * Math.pow(1 - (0.0065 * a) / 288.15, 5.25588)
}
...
const CSS = `
.mb-app{display:flex;flex-direction:column;height:calc(100dvh - 52px);max-width:420px;margin:0 auto;background:#05070a;color:#fff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;user-select:none;overflow:hidden}
...
export default function DashboardPilote() {
  ...
  if (!model) return (
    <div style={{height:'calc(100dvh - 52px)',display:'flex',alignItems:'center',justifyContent:'center',background:'#05070a',color:'#8b949e'}}>
      Chargement...
    </div>
  )
