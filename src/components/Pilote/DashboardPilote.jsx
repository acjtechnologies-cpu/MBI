      ...
      <div className="mb-app" translate="no">
        ...
        {tab === 'calc' && (
          <div className="mb-calc">
            ...
            {espConnected && espEnergiePct !== null && (
              <div style={{ margin:'4px 0', padding:'6px 10px', background:'#0d1117', border:'1px solid #1e2535', borderRadius:8, flexShrink:0 }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:4 }}>
                  <span style={{ fontSize:9, color:'#4a5568', fontWeight:700, letterSpacing:1.5 }}>ENERGIE</span>
                  <span style={{ fontSize:16, fontWeight:900, color: espEnergiePct < 60 ? '#f85149' : espEnergiePct < 100 ? '#f0a500' : espEnergiePct < 140 ? '#3fb950' : espEnergiePct < 170 ? '#00d1b2' : '#e6edf3' }}>{espEnergiePct.toFixed(0)}%</span>
                </div>
                <div style={{ position:'relative', height:12, borderRadius:6, overflow:'hidden' }}>
                  ...
                  <div style={{
                    ...
                    left:`${Math.min(100, Math.max(0, espEnergiePct / 200 * 100))}%`,
                    width:10, height:10, borderRadius:'50%',
                    background: espEnergiePct < 60 ? '#f85149' : espEnergiePct < 100 ? '#f0a500' : espEnergiePct < 140 ? '#3fb950' : espEnergiePct < 170 ? '#00d1b2' : '#e6edf3',
                    border:'2px solid #0b0e12'
                  }} />
                </div>
                <div style={{ display:'flex', justifyContent:'space-between', marginTop:2 }}>
                  <span style={{ fontSize:7, color:'#4a5568' }}>0%</span>
                  <span style={{ fontSize:7, color:'#3fb950', fontWeight:700 }}>100% REF</span>
                  <span style={{ fontSize:7, color:'#4a5568' }}>200%</span>
                </div>
              </div>
            )}
